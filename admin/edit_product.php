        ...
        <div class="row content">
            ...
            <div class="col-sm-9">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE product SET Id = $Id,Category_id = $Category_id,Title = $Title,Image = $Image WHERE Id='$_REQUEST[Id]'";
                ...
                <form method="post" action="edit_product.php">
                    ...
                    <textarea type="text" name="Description" id="Description" style="width: 100% ; height: 200px;"
