        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="Home.php">
                ...
                <span style="color: white;font-family: bradley hand,cursive;"><i class="bi bi-scissors"
                        style="color:white"></i>Venus Handicrafts<i class="bi bi-brush"
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $category) {
                                    ?>
                                    <li><a class="dropdown-item" href="nhap1.php?Id=<?= $category['Id']; ?>">
                ...
                <form class="d-flex" action="header.php" method="get">
                    <input class="inputBOX" style="width:282px" type="text" name="search" placeholder=" Type Here..."
                        required />
