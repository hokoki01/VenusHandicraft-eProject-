...
<ul id="menu-cay-canh-ua-chuong" class="menu">
                                <li id="menu-item-13976"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-13976">
                                    <a href="https://webcaycanh.com/cay-kim-tien/">Cây Kim Tiền</a></li>
                                <li id="menu-item-13823"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-13823">
                                    <a href="https://webcaycanh.com/cay-kim-ngan/">Cây Kim Ngân</a></li>
                                <li id="menu-item-14725"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-14725">
                                    <a href="https://webcaycanh.com/cay-phat-tai/">Cây Phát Tài</a></li>
                                <li id="menu-item-14046"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-14046">
                                    <a href="https://webcaycanh.com/cay-canh-sen-da/">Cây Sen Đá</a></li>
                                <li id="menu-item-14075"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-14075">
                                    <a href="https://webcaycanh.com/cay-hanh-phuc/">Cây Hạnh Phúc</a></li>
                                <li id="menu-item-13977"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-13977">
                                    <a href="https://webcaycanh.com/cay-trau-ba/">Cây Trầu Bà</a></li>
                                <li id="menu-item-14022"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-14022">
                                    <a href="https://webcaycanh.com/cay-bang-singapore/">Cây Bàng Singapore</a></li>
                                <li id="menu-item-13995"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-13995">
                                    <a href="https://webcaycanh.com/cay-luoi-ho/">Cây Lưỡi Hổ</a></li>
                                <li id="menu-item-14875"
                                    class="menu-item menu-item-type-taxonomy menu-item-object-tax_cay menu-item-14875">
                                    <a href="https://webcaycanh.com/phu-kien/">Phụ Kiện</a></li>
                            </ul>
        ...
        <div class="row">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <div class="col-sm-4">
                    <?php
                    $image = $row["Image"];
                    echo "<img src='image_DTB/$image' class='img-responsive' style='width:30%' alt='Image'>";
                    ?>
                </div>
