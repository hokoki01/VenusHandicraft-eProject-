                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Kim Son sedge village has long been famous for
                        sedge cultivation and sedge
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Phu Yen's bottle basket has the special feature of
                        using only local
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Doi Tam drum village is very famous because of its
                        1000-year history of
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Bat Trang pottery is a product that converges the
                        soul and quintessence of
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Van Phuc Silk Village is the most concentrated
                        part of the old Ha Dong Silk
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">The East Lake Painting Village in Bac Ninh has
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Visiting Non Nuoc stone craft village, you not
                        only discover an extremely
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Can Tho is also a place known by the rich
                        diversity of traditional craft
                ...
                <div class="col-md-4 mb-4 h-100 mt-3">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify">Next to the vast Hau River of the rich Mekong
                        Delta.This place is also the
        ...
        <div class="card">
          <div class="card-body py-4 mt-2">
            ...
            <p class="mb-2 fst-italic">
              <i class="fas fa-quote-left pe-2"></i>"On the other hand, we denounce with righteous indignation and
      ...
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="card">
          <div class="card-body py-4 mt-2">
            ...
            <p class="mb-2 fst-italic">
              <i class="fas fa-quote-left pe-2"></i>"Sed ut perspiciatis unde omnis iste natus error sit voluptatem
      ...
      <div class="col-md-4 mb-0">
        <div class="card">
          <div class="card-body py-4 mt-2">
            ...
            <p class="mb-2 fst-italic">
              <i class="fas fa-quote-left pe-2"></i>"But I must explain to you how all this mistaken idea of denouncing
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-6 col-sm-12" style="padding-left: 10px;">
      ...
      <form class="form" method="post" action="Home.php">
        ...
        <button type="submit" id="submit" onclick="submit()" style="color:white"
