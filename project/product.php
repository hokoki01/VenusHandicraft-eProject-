        ...
        <div class="container-fluid px-4">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0 float-end" action=""
                ...
                <div class="input-group">
                    <input class="form-control inputBOX" type="number" name="search"
                        placeholder="Search Product here...." aria-label="Search for..."
                            ...
                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $product) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src='giao-dien/image_DTB/<?= $image = $product['Image']; ?>' class='img-responsive'
                                                style='width:60%' alt='Image'>
                                        </td>
                                        <td>
                                            <?= $product['Description']; ?>
